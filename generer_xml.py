...
def Cadrer(cx,cy,nomclasse,attribut,nbreattribut):
    ...
    svg_document.add(svg_document.text(relation[0],
                                       insert = (110,450)))#(longeur/10+cx, longeur/5+x+cy)))
    svg_document.add(svg_document.text(relation[1],
                                       insert = (270,190)))#(longeur/10+cx, longeur/5+x+cy)))
